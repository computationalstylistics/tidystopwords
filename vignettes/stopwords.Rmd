---
title: "Stopwords with the package 'stopwoRds'"
...
This vignette explains basic functionalities of the package `stopwoRds`. The idea behind 
this package is to give the user control over the stop-word selection, which is
one of the most important steps in any text-mining analysis.
